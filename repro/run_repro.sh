...
mkdir -p .codex_tmp/bsd_closure
cp artifacts/stitch_constants.json .codex_tmp/bsd_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/bsd_closure/constants_registry.json

python3 scripts/bsd_closure_guard.py \
  --strict-coh-zero \
  --registry artifacts/constants_registry.json \
  --stitch artifacts/stitch_constants.json \
